...
docker run --rm -v "$project_dir:/var/www/html" -e "LOG_LEVEL_OUTPUT=off" $PHP_IMAGE composer --working-dir=/var/www/html/ require serversideup/spin:v2.0.0-beta5 --dev